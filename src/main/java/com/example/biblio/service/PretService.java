...
public class PretService {
    ...
    @Transactional
    public Pret demanderPret(String titre, String auteur, Adherent adherent, LocalDateTime datePret) {
        ...
        if (datePret != null) {
            if (datePret.isBefore(LocalDateTime.now())) {
                throw new RuntimeException("La date de prêt doit être aujourd'hui ou une date future");
            }
